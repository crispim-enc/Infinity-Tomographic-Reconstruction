...
class RadialBar(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._ProgressColor = QtGui.QColor(255,255,255)
...
#     w = RadialBar()
#     w.backgroundColor = QtGui.QColor("transparent")
#
#     w.foregroundColor = QtGui.QColor("#191a2f")
#     w.dialWidth = 15
#     w.spanAngle = 280
#     w.textColor = QtGui.QColor("black")
#     w.penStyle = QtCore.Qt.RoundCap
#     # w.dialType = RadialBar.DialType.FullDial
#     w.dialType = RadialBar.DialType.MinToMax
#     w.suffixText = "%"
#     w.textFont.setBold(True)
#     w.textFont.setPointSize(20)
#     w.progressColor=QtGui.QColor("white")
...
#     # if w.value<98:
#     #     print('hello')
#     #     w.foregroundColor = QtGui.QColor("Green")
#     w.show()
#     sys.exit(app.exec_())