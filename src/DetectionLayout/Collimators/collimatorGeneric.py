...
class CollimatorGeometry(object):
    def __init__(self):
        """
        Collimator geometry
    ...
    def calculateInitialPyramidalVertex(self, CztModule, alpha=0, beta=0, sigma=0, x=0, y=0, z=0, angunit="deg"):
        ...
        self._vertex1 = CollimatorGeometry.vectorVertex(CztModule.initialMatrix, distanceFromPoint, shifts)

        distanceFromPoint = [-self._septaLength, -self._boreSize[0] / 2, self._boreSize[1] / 2]
        self._vertex2 = CollimatorGeometry.vectorVertex(CztModule.initialMatrix, distanceFromPoint, shifts)

        distanceFromPoint = [-self._septaLength, -self._boreSize[0] / 2, -self._boreSize[1] / 2]
        self._vertex3 = CollimatorGeometry.vectorVertex(CztModule.initialMatrix, distanceFromPoint, shifts)

        distanceFromPoint = [-self._septaLength, self._boreSize[0] / 2, -self._boreSize[1] / 2]
        self._vertex4 = CollimatorGeometry.vectorVertex(CztModule.initialMatrix, distanceFromPoint, shifts)
